...
typedef enum ompi_spc_counters {
    ...
    OMPI_SPC_REDUCE_BASIC_LOG_COUNT,
    OMPI_SPC_REDUCE_BASIC_LINEAR_COUNT,
    OMPI_SPC_ALLREDUCE_BASIC_LINEAR,
    OMPI_SPC_ALLREDUCE_BASIC_LINEAR_TIME,
    OMPI_SPC_ALLREDUCE_BASE_RECURSIVE_DOUBLING,
    OMPI_SPC_ALLREDUCE_BASE_RECURSIVE_DOUBLING_TIME,
    OMPI_SPC_ALLREDUCE_BASE_RING,
    OMPI_SPC_ALLREDUCE_BASE_RING_TIME,
    OMPI_SPC_ALLREDUCE_BASE_RING_SEGMENTED,
    OMPI_SPC_ALLREDUCE_BASE_RING_SEGMENTED_TIME,
    OMPI_SPC_ALLREDUCE_BASE_NONOVERLAPPING,
    OMPI_SPC_ALLREDUCE_BASE_NONOVERLAPPING_TIME,
    OMPI_SPC_ALLREDUCE_BASE_REDSCAT,
    OMPI_SPC_ALLREDUCE_BASE_REDSCAT_TIME,
